$(function() {
	...
	$(".bConfirm").click( function() {
		jConfirm('Add Stock?', 'Confirmation Dialog', function(r) {
			jAlert('Confirmed: ' + r, 'Confirmation Results');
		});
	});
	
	$(".bPromt").click( function() {
		jPrompt('Tambah Stock Barang:', '', 'Stock Barang', function(r) {
			if( r != '' ) 
			{
	...
	$(".bHtml").click( function() {
		jConfirm('<form action='+baseurl+'>You can use HTML, such as <strong>bold</strong>, <em>italics</em>, and <u>underline</u>!</form>');
	});
